...
export default async function AdminPage({
  ...
  const [admin_t, tCat, tAccess, tJp60, tFb, tPoker] = await Promise.all([
    getTranslations('admin'),
    getTranslations('categories'),
    getTranslations('access'),
    getTranslations('admin_jp60'),
    getTranslations('admin_feedback'),
    getTranslations('admin_poker'),
  ])
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-10">
        ...
        {/* FKO internal members */}
        <Link
          href="/admin/internal-members"
          className="relative bg-paper border border-line rounded-2xl p-5 overflow-hidden hover:border-rose/35 hover:bg-rose-soft/30 hover:-translate-y-0.5 hover:shadow-card transition-all group"
        >
          <div className="absolute -top-8 -right-8 w-28 h-28 bg-rose/4 rounded-full pointer-events-none" />
          <div className="relative">
            ...
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">
              {tAccess('internal_members_card_title')}
            </h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{tAccess('internal_members_card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{admin_t('chat_desc')}</p>
        ...
        <Link
          href="/admin/japanese-60"
          className="relative bg-paper border border-line rounded-2xl p-5 overflow-hidden hover:border-rose/35 hover:bg-rose-soft/30 hover:-translate-y-0.5 hover:shadow-card transition-all group"
        >
          <div className="absolute -top-8 -right-8 w-28 h-28 bg-rose/4 rounded-full pointer-events-none" />
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-rose-soft grid place-items-center font-serif font-bold text-[20px] text-rose mb-3.5 flex-none">
              あ
            </div>
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">
              {tJp60('title')}
            </h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{tJp60('breadcrumb')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">
              {admin_t('tags_card_title')}
            </h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{admin_t('tags_card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">
              {admin_t('search_concepts_card_title')}
            </h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{admin_t('search_concepts_card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
        ...
        >
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-rose-soft grid place-items-center text-[20px] mb-3.5 flex-none">🃏</div>
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">{tPoker('card_title')}</h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{tPoker('card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </span>
        ...
        >
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-rose-soft grid place-items-center text-[20px] mb-3.5 flex-none">🏆</div>
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">{admin_t('tournaments_card_title')}</h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{admin_t('tournaments_card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </span>
        ...
        {/* Explore insights */}
        <Link
          href="/admin/explore-insights"
          className="relative bg-paper border border-line rounded-2xl p-5 overflow-hidden hover:border-rose/35 hover:bg-rose-soft/30 hover:-translate-y-0.5 hover:shadow-card transition-all group"
        >
          <div className="absolute -top-8 -right-8 w-28 h-28 bg-rose/4 rounded-full pointer-events-none" />
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-rose-soft grid place-items-center text-[20px] mb-3.5 flex-none">📊</div>
            <h2 className="font-serif font-bold text-[16.5px] text-ink mb-1 group-hover:text-rose transition-colors">{admin_t('insights_card_title')}</h2>
            <p className="text-[13px] text-muted mb-3.5 leading-relaxed">{admin_t('insights_card_desc')}</p>
            <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-rose bg-rose-soft px-2.5 py-1 rounded-full">
              {admin_t('manage')}
              <svg className="w-3 h-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </span>
