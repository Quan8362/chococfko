      ...
      <div className="w-full max-w-[440px] mx-auto px-7">
        ...
        {user ? (
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 text-center">
            ...
            <Link href="/quen-mat-khau" className="inline-block text-[13.5px] font-semibold px-5 py-2.5 rounded-full bg-amber-500 text-white hover:bg-amber-600 transition-colors">
              {t('forgot_send_btn')}
            </Link>
          </div>
        )}
        ...
        <p className="text-center text-[14px] text-muted mt-6">
          <Link href="/dang-nhap" className="text-rose font-semibold hover:underline">← {t('back_to_login')}</Link>
        </p>
      </div>
    </section>
  )
