  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
      ...
      <div className="bg-paper border border-line rounded-2xl p-6 flex flex-col gap-4">
        <div>
          <h2 className="font-serif font-bold text-[20px] text-ink mb-1">Tạo phòng mới</h2>
          <p className="text-[13.5px] text-muted leading-relaxed">
            Tạo phòng, lấy mã và chia sẻ link mời cho bạn bè.
          </p>
        </div>
      ...
      <div className="bg-paper border border-line rounded-2xl p-6 flex flex-col gap-4">
        <div>
          <h2 className="font-serif font-bold text-[20px] text-ink mb-1">Tham gia phòng</h2>
          <p className="text-[13.5px] text-muted leading-relaxed">
            Nhập mã phòng gồm 5 ký tự mà bạn bè đã chia sẻ.
          </p>
        </div>
