...
const FEATURES = [
  { key: 'dictionary', emoji: '📖', href: '/japanese/dictionary', active: true },
  { key: 'vocabulary', emoji: '📝', href: '/japanese/vocabulary', active: true },
  { key: 'grammar',    emoji: '✏️', href: '/japanese/grammar', active: true },
  { key: 'kanji',      emoji: '漢', href: '/japanese/kanji', active: true },
  { key: 'writing',    emoji: '✍️', href: '/japanese/writing', active: true },
  { key: 'flashcard',  emoji: '🃏', href: '/japanese/flashcards', active: true },
  { key: 'practice',   emoji: '🎯', href: '/japanese/practice', active: true },
  { key: 'jlpt_test',  emoji: '📋', href: '/japanese/jlpt-mock-test', active: true },
  { key: 'study_profile', emoji: '📊', href: '/japanese/profile', active: true },
] as const
