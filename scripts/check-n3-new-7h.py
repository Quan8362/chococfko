...
print()
# Look at entries from ent_seq 1580000 onwards
print("=== Entries with ent_seq >= 1580000 (first 150) ===")
high = [(s, w, r, m) for s, w, r, m in fresh if s >= 1580000]
print(f"Total entries ent_seq >= 1580000: {len(high)}")
print()
for seq, word, reading, meaning in high[:150]:
    try:
