...
print()
# Show entries from 1580000-1585000
print("=== ent_seq 1581600-1585000 ===")
subset = [(s, w, r, m) for s, w, r, m in fresh if 1581600 <= s < 1585000]
print(f"Count: {len(subset)}")
for seq, word, reading, meaning in subset[:100]:
    try:
