# -*- coding: utf-8 -*-
"""Probe staging for N3-level candidates in ent_seq 1100000-1253000 (pre-N4 range)."""
...
def is_good_n3(e):
    ...
    skip = ["botany", "zoology", "chemistry", "physics", "biology", "anatomy",
            ...
            "sericulture", "oyster", "judo", "kendo", "sumo", "martial"]
    for s in skip:
...
all_entries = []
for batch_start in range(1100000, 1253000, 30000):
