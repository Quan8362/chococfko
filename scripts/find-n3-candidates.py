# -*- coding: utf-8 -*-
"""Probe staging for N3-level candidates — words that are NULL/pending."""
...
def is_good_n3(e):
    ...
    skip = ["botany", "zoology", "chemistry", "physics", "biology", "anatomy",
            ...
            "law term", "medicine term", "comp", "math", "elec"]
    for s in skip:
        if s.lower() in meaning.lower():
            return False
    return True

# Probe multiple ent_seq ranges to find N3-appropriate vocabulary
all_entries = []
# N3 vocabulary tends to be in the 1300000-1500000 range (more abstract/formal words)
for batch_start in range(1253000, 1600000, 50000):
