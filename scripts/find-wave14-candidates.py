# -*- coding: utf-8 -*-
"""Find fresh wave 14 candidates from candidates-5b.txt beyond ent_seq 1414600."""
import csv, io, sys
...
print(f"Fresh candidates after ent_seq 1414600: {len(fresh)}")
print()
for seq, word, reading, meaning in fresh[:100]:
    try:
